...
drawText_Outlined(_draw[aR.x1]+20,  _draw[aR.y1]+50, "View["+string(global.PrimaryView)+"]:", _c2, _c1);
drawText_Outlined(_draw[aR.x1]+100, _draw[aR.y1]+50, string(view_get_wport(global.PrimaryView))+", "+string(view_get_hport(global.PrimaryView)), _c3, _c4);
...
drawText_Outlined(_draw[aR.x1]+16,  _draw[aR.y1]+70, "v.Camera["+string(view_camera[global.PrimaryView])+"]:", _c2, _c1);
drawText_Outlined(_draw[aR.x1]+100, _draw[aR.y1]+70, string(camera_get_view_width(view_camera[global.PrimaryView]))+", "+string(camera_get_view_height(view_camera[global.PrimaryView])), _c3, _c4);
