///drawParsedText(x,y,[text_array],[colour_array],[format_array],[default_colour],[alpha],[max_width],[spacing],[line_breaks]);
/// @arg x					{real}
/// @arg y					{real}
...
for ( i=1 ; i<array_length_1d(text_array) ; ++i ) {
	...
	if ( stored_posA ) {
		...
		drawText( x_position, y_position, text_array[i], draw_colour, alpha );
		x_position = draw_x; //Reset x
