///draw_text_button(x,y,text,[colour],[colour_ol],[colour_mo],[alpha],[pop],[outline],[padding],[state]);
/// @arg x				{real}
/// @arg y				{real}
/// @arg text			{string}
...
var button_region = region_bytext( draw_x, draw_y, "text" );
if padding { button_region = region_adjust(button_region,padding+outline) };
