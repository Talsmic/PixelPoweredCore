///_centerCameraOnPoint(camera,target_x,target_y,[x_speed],[y_speed]);
...
var _x_target =		argument[1] - (camera_get_view_width(_camera) div 2);
var _y_target =		argument[2] - (camera_get_view_height(_camera) div 2);
