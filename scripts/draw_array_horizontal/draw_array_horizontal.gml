///draw_array_horizontal(x,y,array,[colour],[alpha],[spacing],[clipwidth],[clip_note]);
/// @arg x			{real}
/// @arg y			{real}
/// @arg array		{array}
...
var spacing =	argument_count > 5 ? argument[5] : array_create(array_length_1d(array),50);
var clipwidth =	argument_count > 6 ? argument[6] : 45;
