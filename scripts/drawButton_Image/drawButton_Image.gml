...
var _text_array =	argument_count > 6 ? _validateArray(argument[6], 5, 5, ["", c_white, 1, 0, c_black]) : ["", c_white, 1, 0, c_black];
...
var _padding =		argument_count > 9 ? _validateArray(argument[9],4,4,argument[9]) : [0];
