///drawTextOutlined(x,y,text,[colour],[ol_colour],[alpha],[thickness],[shadowed_thickness],[shadow_alpha],[shadow_tint]);
/// @arg x				{real}
/// @arg y				{real}
/// @arg text			{string}
...
//Create Surface
var _surface = surface_create( _region[eR.w], _region[eR.h] );
