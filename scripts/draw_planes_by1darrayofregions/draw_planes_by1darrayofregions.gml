///_drawPlanes_by1darrayofregions({array_of_regions},[outline]);
...
for ( var i=0; i<array_length_1d(array_of_regions); ++i ) {
	...
	if is_array(region_array) {
		_drawPlane(region_array[eR.x1],region_array[eR.y1],region_array[eR.w],region_array[eR.h],find_colour(i),draw_get_alpha(),0,outline);
		};
	};