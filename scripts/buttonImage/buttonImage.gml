///buttonImage(x,y,sprite_id,[image_id],[colour],[alpha],[text],[text_align],[pop],[padding],[state]);
/// @arg x				{real}
/// @arg y				{real}
...
//Draw
if ( pop ) { 
	drawSprite(draw_x, draw_y, sprite_id, image_id, colour, alpha); 
	drawSprite(draw_x, draw_y, sprite_id, image_id, c_black, alpha*0.5); 
	};
drawSprite(draw_x, draw_y-pop, sprite_id, image_id, colour, alpha); 
switch ( state ) {	
	case eButtonState.disabled:		
		drawSprite(draw_x, draw_y-pop, sprite_id, image_id, c_gray7, alpha*0.3); break;
	case eButtonState.pressed:
	case eButtonState.mouseover:
		drawSprite(draw_x, draw_y-pop, sprite_id, image_id, c_white, alpha*0.3); break;			
	};
