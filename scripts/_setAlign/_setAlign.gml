...
/*
	...
	<<  Sets  >>	h_align
	<<  Sets  >>	v_align
	<< Returns >>	#align#	{array} [global.Align_X, global.Align_Y, global.Align_Xo, global.Align_Yo];
	Sets the h_align and v_align used for drawing.
	Call with no arguments to reset alignment to the default of fa_left, fa_top
*/
#region Arguments
var input = argument_count > 0 ? _validateArray(argument[0],4,4,[fa_left, fa_right, 0, 0]) : [fa_left, fa_right, 0, 0];
#endregion
...
return [ global.Align_X, global.Align_Y, global.Align_Xo, global.Align_Yo ];
