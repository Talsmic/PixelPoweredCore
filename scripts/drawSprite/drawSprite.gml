///drawSprite([x],[y],[sprite_id],[image_id],[colour],[alpha]);
...
if ( is_array(_colour) ) {	draw_sprite_general( _sprite, _image, 0, 0, sprite_get_width(_sprite), sprite_get_height(_sprite), _x, _y, 1, 1, 0, _colour[0], _colour[1], _colour[2], _colour[3], _alpha ) } 
					else {  draw_sprite_ext( _sprite, _image, _x, _y, 1, 1, 0, _colour, _alpha )	};