///_drawRegion({region_array},[colour],[alpha],[outline],[rotation]);
...
//Draw the plane
_drawPlane(region_array[eR.x1], region_array[eR.y1], region_array[eR.w], region_array[eR.h], colour, alpha, outline, rotation);